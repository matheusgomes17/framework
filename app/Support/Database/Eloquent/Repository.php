...
namespace MVG\Support\Database\Eloquent;

use Illuminate\Database\DatabaseManager;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Collection;
use MVG\Support\Database\Eloquent\Traits\EloquentBuilderTrait;

/**
 * Class Repository
 * @package MVG\Support\Database\Eloquent
 */
abstract class Repository
{
     ...
     * More info to https://laravel.com/docs/5.5/eloquent#defining-models
     * @return string
     */
