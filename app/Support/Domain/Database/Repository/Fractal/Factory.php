...
namespace MVG\Support\Domain\Database\Repository\Fractal;

use ArrayAccess;
use MVG\Support\Domain\Database\Repository\Contracts\Fractal\Factory as FactoryContract;
use MVG\Support\Domain\Database\Repository\Fractal\Transformers\GenericTransformer;
...
/**
 * Class Factory
 * @package MVG\Support\Domain\Database\Repository\Fractal
 */
class Factory implements FactoryContract
{
    ...
    protected function getFractalFactory()
    {
        if (!$this->fractal) {
            ...
            $serializer = $this->app['config']->get('support.repository.fractal.serializer', null);
