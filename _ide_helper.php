...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            return \MVG\Units\ConsoleKernel::handle($input, $output);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \MVG\Units\ConsoleKernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \MVG\Units\ConsoleKernel::command($signature, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \MVG\Units\ConsoleKernel::registerCommand($command);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \MVG\Units\ConsoleKernel::call($command, $parameters, $outputBuffer);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \MVG\Units\ConsoleKernel::queue($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \MVG\Units\ConsoleKernel::all();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \MVG\Units\ConsoleKernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \MVG\Units\ConsoleKernel::bootstrap();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \MVG\Units\ConsoleKernel::setArtisan($artisan);
        }
    ...
    class Auth {
         ...
         *
         * @return \MVG\Domains\Users\Models\User|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \MVG\Domains\Users\Models\User|false 
         * @static 
         */ 
    ...
    class Redirect {
         ...
         * @static 
         */ 
        public static function routeTenant($name, $params = array(), $status = 302, $headers = array())
        {
            return \MVG\Support\Http\Routing\Redirector::routeTenant($name, $params, $status, $headers);
        }
        ...
        public static function home($status = 302)
        {
            ...
            return \MVG\Support\Http\Routing\Redirector::home($status);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::back($status, $headers, $fallback);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::refresh($status, $headers);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::guest($path, $status, $headers, $secure);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::intended($default, $status, $headers, $secure);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::to($path, $status, $headers, $secure);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::away($path, $status, $headers);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::secure($path, $status, $headers);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::route($route, $parameters, $status, $headers);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::action($action, $parameters, $status, $headers);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            return \MVG\Support\Http\Routing\Redirector::getUrlGenerator();
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\Redirector            
            \MVG\Support\Http\Routing\Redirector::setSession($session);
        }
...
namespace  { 
    ...
    class Repositories extends \Illuminate\Database\Eloquent\Model {        }
    ...
    class Resources extends \Illuminate\Support\Facades\Response {}
