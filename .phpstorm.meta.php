...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'redirect' => \MVG\Support\Http\Routing\Redirector::class,
        ...
        'Illuminate\Contracts\Http\Kernel' => \MVG\Units\HttpKernel::class,
        'Illuminate\Contracts\Console\Kernel' => \MVG\Units\ConsoleKernel::class,
        'Illuminate\Contracts\Debug\ExceptionHandler' => \MVG\Units\ExceptionHandler::class,
        ...
        'migrator.repository' => \Migrator\DatabaseMigrationRepository::class,
        'migrator.instance' => \Migrator\Migrator::class,
        'migrator.seeder.manager' => \Migrator\Seeder\Manager::class,
        'migrator.creator' => \Migrator\MigrationCreator::class,
        'command.migrator' => \Migrator\Console\MigrateCommand::class,
        'command.migrator.rollback' => \Migrator\Console\RollbackCommand::class,
        'command.migrator.reset' => \Migrator\Console\ResetCommand::class,
        'command.migrator.refresh' => \Migrator\Console\RefreshCommand::class,
        'command.migrator.install' => \Migrator\Console\InstallCommand::class,
        'command.migrator.make' => \Migrator\Console\MigratorMakeCommand::class,
        'command.migrator.status' => \Migrator\Console\StatusCommand::class,
        ...
        'MVG\Domains\Users\Contracts\Repositories\UserRepositoryContract' => \MVG\Domains\Users\Repositories\UserRepository::class,
        'MVG\Domains\Authentication\Contracts\Repositories\PermissionRepositoryContract' => \MVG\Domains\Authentication\Repositories\PermissionRepository::class,
        'MVG\Domains\Authentication\Contracts\Repositories\RoleRepositoryContract' => \MVG\Domains\Authentication\Repositories\RoleRepository::class,
        'MVG\Domains\Categories\Contracts\Repositories\CategoryRepositoryContract' => \MVG\Domains\Categories\Repositories\CategoryRepository::class,
        ...
        'Spatie\Permission\Contracts\Permission' => \MVG\Domains\Authentication\Models\Permission::class,
        'Spatie\Permission\Contracts\Role' => \MVG\Domains\Authentication\Models\Role::class,
